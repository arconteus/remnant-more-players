...
State the exact executable restriction, manual helper requirement, reported mixed-platform success with the previous four-player version and untested five-player support, and unverified travel behavior in the GitHub/Nexus description. Explain that the helper writes one byte in the running game and is included as readable source. Do not describe it as universal Steam support or a complete Survival fix.
